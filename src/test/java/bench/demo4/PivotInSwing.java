...
/**
 * http://weblogs.java.net/blog/gkbrown/archive/2010/10/12/combining-swing-and-
 * apache-pivot
 */
public class PivotInSwing extends ApplicationContext {
	...
	private static void createSwingFrame() {
		...
		final JCheckBox jCheckBox = new JCheckBox("JCheckBox");
		...
		final JRadioButton jRadioButton1 = new JRadioButton("JRadioButton 1",
				true);
		buttonGroup.add(jRadioButton1);
		box.add(jRadioButton1);

		final JRadioButton jRadioButton2 = new JRadioButton("JRadioButton 2",
				true);
		buttonGroup.add(jRadioButton2);
		box.add(jRadioButton2);

		final JRadioButton jRadioButton3 = new JRadioButton("JRadioButton 3",
				true);
	...
	private static void createPivotFrame() {
		...
		final ApplicationContext.DisplayHost displayHost = new ApplicationContext.DisplayHost();
		...
		Window window;
		try {
			window = (Window) bxmlSerializer.readObject(PivotInSwing.class
					.getResource("pivot_window.bxml"));
